...
export const dangerBtnClass = `text-error border-2 border-error/40 hover:text-errorHover disabled:text-error hover:border-errorHover/40 disabled:border-error/40 ${sharedStyles}`;
